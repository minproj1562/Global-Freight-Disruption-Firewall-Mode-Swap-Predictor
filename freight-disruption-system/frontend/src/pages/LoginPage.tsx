...
import { Ship, Mail, Lock, ArrowLeft, Loader2, ShieldCheck, AlertCircle, X, Compass, Globe, Anchor } from 'lucide-react';
          ...
          <div className="lg:col-span-5 p-8 lg:p-12 bg-gradient-to-br from-slate-900/90 via-slate-950/90 to-blue-950/60 border-r border-slate-800/60 flex flex-col justify-between min-h-[480px]">
            <div>
              ...
              <p className="text-sm text-slate-400 leading-relaxed mb-6">
                Real-time AIS tracking, geopolitical disruption firewalling, and AI-driven intermodal route swapping.
              </p>
              ...
              <div className="p-3.5 rounded-2xl bg-emerald-500/10 border border-emerald-500/30 mb-4">
                <div className="flex items-center gap-2 text-xs font-bold text-emerald-300 mb-1">
                  ...
                  Are you a Port / Terminal Manager?
                </div>
                <p className="text-[11px] text-slate-300 mb-2">
                  Access the dedicated Port Manager registration & login with Employee ID, Assigned Port & Terminal Clearance.
                </p>
                <Link
                  to="/auth/port-manager"
          ...
          <div className="lg:col-span-7 p-8 lg:p-12">
            <div className="max-w-md mx-auto">
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <div className="space-y-1">
                  ...
                  <div className="relative">
                    ...
                    <Input
                      ...
                      required
                      className={`pl-10 h-10 bg-slate-950/80 border ${
                        emailTouched && !isEmailValid ? 'border-rose-500/80' : 'border-slate-800 focus:border-amber-400'
                      } text-white placeholder:text-slate-500 rounded-xl text-xs transition-all`}
                    />
                  </div>
                ...
                <div className="space-y-1">
                  ...
                  <div className="relative">
                    ...
                    <Input
                      ...
                      required
                      className={`pl-10 h-10 bg-slate-950/80 border ${
                        passwordTouched && !isPasswordValid ? 'border-rose-500/80' : 'border-slate-800 focus:border-amber-400'
                      } text-white placeholder:text-slate-500 rounded-xl text-xs transition-all`}
                    />
                  </div>
                </div>
                ...
                <div className="space-y-1.5">
                  ...
                  <div className="grid grid-cols-3 gap-2">
                    {[
                      { value: 'operations', label: 'Global Fleet', emoji: '🚢' },
                      { value: 'port', label: 'Port Manager', emoji: '⚓' },
                      { value: 'admin', label: 'Admin Ops', emoji: '⚙️' },
                    ].map((role) => (
                      <button
                        key={role.value}
                        type="button"
                ...
                <AnimatePresence>
                  {error && (
                    <motion.div
                      ...
                      className="rounded-xl bg-rose-500/15 border border-rose-500/40 p-3 flex items-start gap-2.5"
                    >
                ...
                <Button
                  type="submit"
                  disabled={isLoading}
                  className="w-full bg-gradient-to-r from-amber-500 via-amber-400 to-yellow-500 hover:from-amber-400 hover:to-yellow-400 text-slate-950 font-bold py-3 text-sm rounded-xl shadow-lg shadow-amber-500/20 hover:shadow-amber-500/30 transition-all flex items-center justify-center"
                >
                  {isLoading ? (
                    <>
              ...
              <div className="mt-5 text-center text-xs text-slate-400 space-y-1">
                ...
                <div>
                  Standard enterprise registration?{' '}
              ...
              {!forgotSent ? (
                <div>
                  ...
                  <p className="text-xs text-slate-400 mb-4">
                    Enter your registered enterprise email address to receive password reset links.
                  </p>
